...
<span class="border">
<a class="url" href="'.$entry['url'].'" id="'.$level.'_'.$entry['id'].'" title="'.htmlentities($entry['url']).'"><span id="title-'.$level.'_'.$entry['id'].'">'.$entry['name'].'</span></a>
...
<a class="edit" href="javascript:;" onclick="toggleShow(\'entry-'.$level.'_'.$entry['id'].'\');toggleShow(\'editform-'.$level.'_'.$entry['id'].'\')">Edit</a>
<a class="bookmarklet" href="javascript:var url=\''.$site_url.'\';var x=document.createElement(\'SCRIPT\');x.type=\'text/javascript\';x.src=url+\'bookmarklet.php?d='.$level.'_'.$entry['id'].'\';document.getElementsByTagName(\'head\')[0].appendChild(x);void(0);" title="Drag to add bookmarklet">Add to '.htmlentities($entry['name']).'</a>

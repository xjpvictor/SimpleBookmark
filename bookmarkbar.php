...
if (!$auth) {
  echo 'bml.innerHTML=\'<div style="margin:0 10px;">\'+bml.innerHTML+\'<p style="margin:0;padding:0;line-height:27px;font-size:14px;text-align:center;">Please <a href="'.$site_url.'" target="_blank">log in</a></p></div>\';';
  exit;
}
